...
function serve(req, res) {
    ...
    if (pathname === '/' || (pathname && pathname.substr(-1) === '/')) {
        findDefaultFile(pathname, req, res);
        return false;
    }
 ...
 * */
function findDefaultFile(pathname, req, res) {
...
function render(fileName, req, res) {
    ...
    fileName = path.basename(fileName); //fileName.slice(1, fileName.length);
